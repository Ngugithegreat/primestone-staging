      ...
      <Card className="p-4">
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative min-w-[220px] flex-1">
            ...
            <input
              ...
              className="h-10 w-full rounded-none border border-white/[0.08] bg-ink-900 pl-10 pr-9 text-[13.5px] text-white outline-none transition-colors placeholder:text-slate-500 focus:border-mint-500/50"
            />
            {query && (
              <button
                onClick={() => setQuery("")}
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-10 rounded-none border border-white/[0.08] bg-ink-900 px-3 text-[13.5px] text-white outline-none focus:border-mint-500/50 [&>option]:bg-ink-800"
            >
              {SORTS.map((s) => (
        ...
        <div className="mt-3.5 flex flex-wrap items-center gap-x-5 gap-y-3">
          ...
          <button
            ...
            className={cn(
              "focus-ring rounded-none border px-3 py-1.5 text-[12px] font-medium transition-colors",
              verifiedOnly
          ...
          {visible < results.length && (
            <div className="mt-8 flex flex-col items-center gap-3">
              ...
              <button
                ...
                className="focus-ring rounded-none border border-white/10 bg-white/[0.04] px-6 py-2.5 text-[13.5px] font-medium text-white transition-colors hover:bg-white/[0.09]"
              >
                Load more providers
              </button>
            </div>
