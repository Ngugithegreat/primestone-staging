...
export function AuthLayout({
  ...
  return (
    <div className="grid min-h-dvh lg:grid-cols-[1fr_auto]">
      ...
      {/* ---- Marketing side ----------------------------------------------- */}
      <aside className="relative hidden w-[440px] overflow-hidden border-l border-white/[0.07] bg-ink-900 xl:block">
        <div
        ...
        <div className="relative flex h-full flex-col justify-between p-10">
          ...
          <motion.figure
            ...
            className="card-sheen rounded-none border border-white/[0.09] bg-ink-880 p-5 "
          >
