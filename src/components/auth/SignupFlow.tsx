          ...
          >
                ...
                {ACCOUNT_TYPES.map((a) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "focus-ring relative rounded-none border p-5 text-left transition-all duration-250",
                        active
            ...
            {step === 2 && (
              <div className="space-y-5">
                    ...
                    {LEVERAGE_OPTIONS.map((l) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "focus-ring rounded-none border py-2.5 text-[13.5px] font-medium transition-all",
                            disabled
                  ...
                  <div className="space-y-2">
                    {EXPERIENCE.map((x) => (
                      <button
                        ...
                        className={cn(
                          "focus-ring flex w-full items-center justify-between rounded-none border px-4 py-3 text-left transition-all",
                ...
                <div className="rounded-none border border-mint-500/25 bg-mint-500/[0.07] p-4">
              ...
              <div className="text-center">
                ...
                <div className="mt-7 grid gap-2.5 text-left">
                  {[
                    ...
                    <div
                      key={k}
                      className="flex items-center justify-between rounded-none border border-white/[0.07] bg-white/[0.02] px-4 py-3"
                    >
