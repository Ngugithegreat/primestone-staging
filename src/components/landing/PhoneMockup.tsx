      ...
      <div className="rounded-[42px] border border-white/12 bg-ink-950 p-2.5 shadow-[0_50px_120px_-30px_rgba(0,0,0,0.9)]">
        <div className="relative overflow-hidden rounded-[34px] border border-white/[0.06] bg-ink-900">
          ...
          <div className="px-4 pb-5 pt-8">
            ...
            {/* balance card */}
            <div className="mt-3 rounded-none border border-white/[0.08] bg-ink-880 p-3.5">
            ...
            <div className="mt-2.5 grid grid-cols-3 gap-1.5">
              {[
                ...
                <div key={l} className="rounded-none border border-white/[0.06] bg-white/[0.02] p-2">
            ...
            <div className="mt-2.5 space-y-1.5">
              {[
                ...
                <div
                  key={who as string}
                  className="flex items-center justify-between rounded-none border border-white/[0.05] bg-white/[0.02] px-2.5 py-1.5"
                >
            ...
            {/* CTA */}
            <div className="mt-3 flex items-center justify-center gap-1.5 rounded-none bg-mint-500 py-2 text-[11px] font-semibold text-ink-950">
