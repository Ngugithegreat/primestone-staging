...
export function EngineMonitor() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Risk control */}
      <div className="flex flex-wrap items-center gap-3 rounded-none border border-white/[0.09] bg-ink-880 p-4">
                  ...
                  <tr key={p.id} className="border-b border-white/[0.04] last:border-0">
                    ...
                    <td className="px-4 py-3 text-right">
                      <button
                        ...
                        disabled={busy !== null}
                        className="focus-ring inline-flex items-center gap-1 rounded-none border border-rose-500/25 bg-rose-500/[0.08] px-2.5 py-1.5 text-[12px] font-medium text-rose-300 transition-colors hover:bg-rose-500/[0.16] disabled:opacity-40"
                      >
            ...
            {data.recentClosed.map((c) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 text-slate-400">
                  ...
                  <span className="rounded-none bg-white/[0.06] px-1.5 py-0.5 text-[11px] text-slate-400">
                    {c.reason ?? "closed"}
                  </span>
                </div>
              </div>
      ...
      <div className="rounded-none border border-amber-450/30 bg-amber-450/[0.05] p-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="focus-ring inline-flex items-center gap-1.5 rounded-none border border-rose-500/40 bg-rose-500/[0.1] px-3.5 py-2 text-[12.5px] font-semibold text-rose-300 hover:bg-rose-500/[0.18]"
          >
...
function Stat({
  ...
  return (
    <div className="card-sheen rounded-none border border-white/[0.07] bg-ink-880 p-4">
...
function AddProviderForm({
  ...
  return (
    <div className="rounded-none border border-white/[0.09] bg-ink-880 p-5">
      <div className="flex items-center justify-between">
              ...
              <div className="flex gap-1.5">
                {(["buy", "sell"] as const).map((s) => (
                  <button
                    ...
                    onClick={() => setSide(s)}
                    className={cn(
                      "flex-1 rounded-none border py-2 text-[12.5px] font-medium capitalize transition-colors",
                      side === s
                        ? s === "buy"
