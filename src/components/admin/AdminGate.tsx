  ...
  return (
    <div className="relative grid min-h-dvh place-items-center overflow-hidden bg-ink-950 px-5">
      ...
      <motion.div
        ...
        className="card-sheen relative w-full max-w-sm rounded-none border border-white/[0.09] bg-ink-880 p-7 "
      >
        <div className="flex items-center gap-3">
          <div className="grid h-11 w-11 place-items-center rounded-none border border-iris-500/25 bg-iris-500/10">
        ...
        {!configured ? (
          <p className="mt-6 rounded-none border border-amber-450/25 bg-amber-450/[0.07] p-3 text-[12.5px] leading-relaxed text-amber-200">
            Admin access is not configured yet. Set an{" "}
            <code className="rounded-none bg-white/10 px-1">ADMIN_PASSWORD</code> environment variable in
            Vercel and redeploy.
          </p>
        ) : (
