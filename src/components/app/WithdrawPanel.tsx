  ...
  return (
    <Card className="card-sheen overflow-hidden p-0">
      <div className="relative p-6">
        ...
        {state === "verify" ? (
          <div className="relative mt-5 grid place-items-center rounded-none border border-amber-450/25 bg-amber-450/[0.05] px-5 py-9 text-center">
            <span className="grid h-14 w-14 place-items-center rounded-none bg-amber-450/12">
            ...
            <div className="mt-5 flex gap-2.5">
              ...
              <Link
                href="/verify"
                className="focus-ring inline-flex h-9 items-center gap-1.5 rounded-none bg-mint-500 px-4 text-[13px] font-semibold text-ink-950 hover:bg-mint-400"
              >
                Verify identity
          ...
          /* ---- 2FA code step --------------------------------------------- */
          <div className="relative mt-5 grid place-items-center rounded-none border border-iris-500/25 bg-iris-500/[0.05] px-5 py-8 text-center">
            <span className="grid h-14 w-14 place-items-center rounded-none bg-iris-500/12">
          ...
          <div className="relative mt-5 grid place-items-center rounded-none border border-mint-500/25 bg-mint-500/[0.07] px-5 py-9 text-center">
            ...
            <div className="grid grid-cols-2 gap-2">
              {([
                ...
                <button
                  ...
                  className={cn(
                    "focus-ring flex items-center justify-center gap-2 rounded-none border px-3 py-2.5 text-[13px] font-medium transition",
                    method === m.key
              ...
              <div className="relative">
                ...
                {!noFunds && (
                  <button
                    ...
                    className="focus-ring absolute right-2 top-1/2 -translate-y-1/2 rounded-none border border-white/10 bg-white/[0.05] px-2 py-1 text-[11px] font-medium text-slate-300 hover:bg-white/[0.1]"
                  >
                    Max
                  </button>
                )}
