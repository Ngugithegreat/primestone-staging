...
function DepositPanel({
  ...
  return (
    <div className="space-y-3">
      <div className="inline-flex rounded-none border border-white/[0.08] bg-white/[0.03] p-1">
        {(["mpesa", "crypto"] as const).map((t) => (
          <button
            key={t}
            onClick={() => setTab(t)}
            className={cn(
              "rounded-none px-4 py-1.5 text-[13px] font-medium transition-colors",
  ...
  return (
    <Card className="p-6">
      <div className="flex items-center gap-2.5">
        <span className="grid h-9 w-9 place-items-center rounded-none border border-mint-500/25 bg-mint-500/10">
      ...
      {state === "done" ? (
        <div className="mt-5 grid place-items-center rounded-none border border-mint-500/25 bg-mint-500/[0.07] px-4 py-8 text-center">
        ...
        <div className="mt-5 rounded-none border border-white/[0.08] bg-white/[0.02] p-5">
          <div className="flex items-center gap-2.5">
            {state === "slow" ? (
          ...
          {message && (
            <div
              className={cn(
                "mt-4 rounded-none border p-3 text-[12.5px] leading-relaxed",
                state === "slow"
        ...
        <div className="mt-5 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[100, 200, 300, 500, 1000].map((v) => (
              <button
                ...
                onClick={() => setAmount(v)}
                className={cn(
                  "rounded-none border px-3 py-1.5 text-[12.5px] transition-colors",
                  amount === v
          ...
          <div className="flex items-center justify-between rounded-none border border-white/[0.06] bg-white/[0.02] px-3.5 py-2.5">
          ...
          {message && state === "failed" && (
            <div className="flex items-start gap-2 rounded-none border border-rose-500/25 bg-rose-500/[0.06] p-3 text-[12.5px] text-rose-300">
...
function CryptoDeposit({ onCredited }: { onCredited: () => Promise<void> }) {
  ...
  return (
    <Card className="p-6">
      <div className="flex items-center gap-2.5">
        <span className="grid h-9 w-9 place-items-center rounded-none border border-iris-500/25 bg-iris-500/10">
      ...
      {state === "done" ? (
        ...
        <div className="mt-5 space-y-3">
          <div className="rounded-none border border-iris-500/20 bg-iris-500/[0.05] p-4">
          ...
          <div className="rounded-none border border-white/[0.08] bg-white/[0.02] p-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="focus-ring grid h-8 w-8 shrink-0 place-items-center rounded-none border border-white/10 bg-white/[0.04] text-slate-300 hover:bg-white/[0.09]"
              >
                {copied ? <Check className="h-4 w-4 text-mint-400" /> : <Copy className="h-4 w-4" />}
              </button>
            </div>
          </div>
          <div className="flex items-start gap-2 rounded-none border border-amber-450/30 bg-amber-450/[0.08] p-3 text-[12px] text-amber-200">
          ...
          <div className="flex items-start gap-2 rounded-none border border-amber-450/25 bg-amber-450/[0.06] p-3 text-[12px] text-amber-300">
            ...
            <div className="space-y-2">
              {NETWORKS.map((n) => (
                <button
                  ...
                  className={cn(
                    "flex w-full items-center justify-between rounded-none border px-3.5 py-2.5 text-left transition-colors",
                    coin === n.id
  ...
  return (
    <Card className="p-6">
      ...
      <div className="mt-5 space-y-3">
        ...
        {providers.map((p) => (
          <div key={p.id} className="rounded-none border border-white/[0.07] bg-white/[0.02] p-3.5">
            ...
            <AnimatePresence initial={false}>
              {openId === p.id ? (
                ...
                <button
                  ...
                  className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-none border border-white/10 bg-white/[0.03] py-2 text-[12.5px] font-medium text-slate-200 transition-colors hover:bg-white/[0.07]"
                >
