...
export function StatTile({
  ...
  return (
    <motion.div
      ...
      className="card-sheen relative overflow-hidden rounded-none border border-white/[0.07] bg-ink-880 p-4 "
    >
      <div
      ...
      <div className="relative flex items-start justify-between gap-3">
        ...
        <span
          className="grid h-9 w-9 shrink-0 place-items-center rounded-none border"
          style={{
