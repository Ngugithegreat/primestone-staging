    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {status === "verified" && (
          <Link
            href="/wallet"
            className="focus-ring inline-flex h-10 items-center gap-1.5 rounded-none bg-mint-500 px-4 text-[13.5px] font-semibold text-ink-950 hover:bg-mint-400"
          >
            Go to wallet
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {STEPS.map((s) => (
            <Card key={s.n} className="p-4">
              <div className="grid h-8 w-8 place-items-center rounded-none bg-mint-500/12 text-[13px] font-bold text-mint-400">
                {s.n}
              </div>
