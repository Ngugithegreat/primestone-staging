      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <span
            className={
              enabled
                ? "grid h-10 w-10 shrink-0 place-items-center rounded-none border border-mint-500/25 bg-mint-500/10"
                : "grid h-10 w-10 shrink-0 place-items-center rounded-none border border-white/[0.08] bg-white/[0.03]"
            }
          >
...
function SetupModal({ onClose, onEnabled }: { onClose: () => void; onEnabled: () => void }) {
  ...
  return (
    ...
    >
      {backupCodes ? (
        <div>
          <div className="grid grid-cols-2 gap-2 rounded-none border border-white/[0.08] bg-ink-950 p-4">
            {backupCodes.map((c) => (
        ...
        <div className="space-y-4">
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start">
            <div className="shrink-0 rounded-none border border-white/10 bg-white p-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 break-all rounded-none border border-white/[0.08] bg-white/[0.02] px-3 py-2 font-mono text-[12.5px] tracking-wide text-slate-200">
                {data.secret}
              </p>
            </div>
          </div>
