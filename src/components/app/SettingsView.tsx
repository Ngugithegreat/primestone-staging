        ...
        <div className="space-y-4">
              ...
              {ACCOUNT_TYPES.map((a) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "focus-ring rounded-none border p-4 text-left transition-all duration-200",
                      active
          ...
          <Card className="overflow-hidden">
            ...
            <div className="space-y-4 p-4">
                  ...
                  {LEVERAGE_OPTIONS.map((l) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "focus-ring rounded-none border py-2 text-[12.5px] font-medium transition-all",
                          disabled
              ...
              <p className="rounded-none border border-amber-450/25 bg-amber-450/[0.07] p-3 text-[12px] leading-relaxed text-amber-450">
        ...
        <div className="space-y-4">
          ...
          <Card className="overflow-hidden">
            ...
            <div className="p-4">
              <div className="flex items-center gap-3">
                <span
                  className={cn(
                    "grid h-11 w-11 shrink-0 place-items-center rounded-none border",
                    user.kycVerified
          ...
          <Card className="overflow-hidden">
            ...
            <div className="space-y-2.5 p-4">
              <TwoFactorCard />
              <button className="focus-ring flex w-full items-center gap-3 rounded-none border border-white/[0.07] bg-white/[0.02] px-4 py-3 text-left transition-colors hover:bg-white/[0.05]">
          ...
          <Card className="overflow-hidden border-rose-500/20">
            ...
            <div className="space-y-2.5 p-4">
              <button
                ...
                className="focus-ring flex w-full items-center gap-3 rounded-none border border-white/[0.07] bg-white/[0.02] px-4 py-3 text-left transition-colors hover:bg-white/[0.05]"
              >
              ...
              <button
                ...
                className="focus-ring flex w-full items-center gap-3 rounded-none border border-rose-500/20 bg-rose-500/[0.05] px-4 py-3 text-left transition-colors hover:bg-rose-500/10"
              >
