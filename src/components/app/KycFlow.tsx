...
export function KycFlow({ compact = false }: { compact?: boolean }) {
        ...
        {serverDocs.length > 0 && (
          <div className="mt-4 grid grid-cols-2 gap-2">
            {serverDocs.map((d) => (
              <div
                key={d.type}
                className="flex items-center gap-2 rounded-none border border-white/[0.07] bg-white/[0.02] px-3 py-2"
              >
  ...
  return (
    <div className={cn(!compact && "space-y-5")}>
      {status === "rejected" && (
        <div className="mb-5 flex items-start gap-3 rounded-none border border-rose-500/25 bg-rose-500/[0.07] p-4">
      ...
      <div className="flex items-center gap-2 rounded-none border border-white/[0.07] bg-white/[0.02] px-4 py-3">
...
function DocDrop({
  ...
  return (
    <div
      className={cn(
        "relative rounded-none border border-dashed p-4 transition-colors",
        doc
    ...
    >
      ...
      {uploading ? (
        <div className="flex items-center gap-3">
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-none bg-iris-500/15">
        ...
        <div className="flex items-center gap-3">
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-none bg-mint-500/15">
          ...
          <button
            onClick={onClear}
            aria-label="Remove"
            className="grid h-6 w-6 shrink-0 place-items-center rounded-none text-slate-400 hover:bg-white/10 hover:text-white"
          >
        ...
        <button onClick={() => ref.current?.click()} className="flex w-full items-center gap-3 text-left">
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-none border border-white/10 bg-white/[0.03]">
...
function StatusPanel({
  ...
  return (
    <motion.div
      ...
      className={cn("rounded-none border p-6", toneCls)}
    >
      <div className="flex items-start gap-4">
        <div className="grid h-12 w-12 shrink-0 place-items-center rounded-none bg-current/10">
